...
public class CommonDbUtilsJdbcStore {
    ...
    public <T> List<T> selectList(String sql, Class<T> tClass, Object... params)  {
        ...
        try {
            conn = CustomDBConnectionManager.getInstance().getConnection();
            results = runner.query(conn, sql, new BeanListHandler<T>(tClass), params);
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
            if (conn != null){
    ...
    public <T> List<T> selectList(String sql, ResultSetHandler<List<T>> resultSetHandler, Object... params)  {
        ...
        try {
            conn = CustomDBConnectionManager.getInstance().getConnection();
            results = (List<T>) runner.query(conn, sql, resultSetHandler, params);
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
            if (conn != null){
